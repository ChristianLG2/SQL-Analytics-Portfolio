...
| 02 | [Cohort Retention Analysis](./02_cohort_retention/) | Enrollment cohorts · Completion rates · LAG() · Rolling averages | T-SQL · Python · Seaborn | ✅ Complete |
| 03 | [Query Optimization](./03_query_optimization/) | Execution plans · Index analysis · Performance tuning | T-SQL · SSMS | ✅ Complete |
